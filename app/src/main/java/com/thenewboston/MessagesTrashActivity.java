...
public class MessagesTrashActivity extends NBBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        currentActivity = "trash";
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_messages_trash);
    ...
    {
        mRecyclerView = (RecyclerView) findViewById(R.id.messages_trash_recycler_view);
    ...
    private void loadMessageInfo()
    {
        ...
        NBRestAPIManager apiManager = new NBRestAPIManager("message", "getTrash", nbUserApiToken, "post");
