...
public class MessagesSentActivity extends NBBaseActivity {
    ...
    {
        mRecyclerView = (RecyclerView) findViewById(R.id.messages_sent_recycler_view);
    ...
    private void loadMessageInfo()
    {
        ...
        NBRestAPIManager apiManager = new NBRestAPIManager("message", "getSent", nbUserApiToken, "post");
